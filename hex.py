...
if __name__ == "__main__":
    ...
    parser.add_argument('--puzzle', default='1',
                        help='enable puzzle mode')
    ...
    visual = args.visual
    if args.puzzle:
        puzzle_number = int(args.puzzle.strip())
        print('you asked for puzzle number ' + str(puzzle_number)) #REMOVE
...
def compute_paths(rows, cols, cell_to_avoid, player):
    ...
    if rows == 1:
        ...
        if cell_to_avoid:
            lengths_avoiding_cell[1] -= len(cell_to_avoid)
